                ...
                <div class="span12">
                    ...
                    <div class="widget">
                        ...
                        <?php echo $this->session->flashdata("status"); ?>
                            <div class="form">
                                <!-- BEGIN FORM-->
                                <form id="form" method="POST" action="<?php echo base_url(); ?>Adm_rord/src" class="form-horizontal form-row-seperated">
                                    ...
                                    <a href="<?php echo base_url() ?>Adm_rord" class="btn btn-primary">REFRESH</a>
                                </form>
                                <!-- END FORM-->
                            </div>
